...
bool InitPlatformBackend(HWND& hwnd) {
    ...
    ::RegisterClassExW(&wc);
    std::wstring wtitle = std::wstring(Config::APPLICATION_TITLE, Config::APPLICATION_TITLE + strlen(Config::APPLICATION_TITLE));
    hwnd = ::CreateWindowW(wc.lpszClassName, wtitle.c_str(), WS_OVERLAPPEDWINDOW,
